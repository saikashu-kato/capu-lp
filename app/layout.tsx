...
export const metadata: Metadata = {
  title: '株式会社Capu',
  description: '私たちは「世の中に本当に必要だ」と信じた体験だけをつくる。革新的なアイデアと確かな技術力で、女子向けエンタメマッチングサービス「Capu」を展開しています。',
  keywords: ['Capu', 'エンタメ', 'マッチング', '女子向け', 'アプリ', 'スタートアップ', 'テクノロジー', '株式会社Capu'],
